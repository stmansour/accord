...
aws ec2 run-instances --output json --image-id ${AMI} --count ${instances} --instance-type t2.micro --key-name smanAWS1  --security-groups Windows-Jenkins --user-data file://winjenk.scr > new-windows-jenkins-instance.json
popd
date
